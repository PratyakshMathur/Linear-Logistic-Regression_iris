...
import numpy as np
from train_LinearRegression2 import X_test,y_test

mini_batch_model = LinearRegression()
mini_batch_model.load("regression2_mini_model_1.npz")
...
batch_model.load("regression2_batch_model_1.npz")
...
stochastic_model.load("regression2_stochastic_model_1.npz")
...
normal_equation_model.load("regression2_normal_equation_model_1.npz")
...
best.save("best_regression_model_2.npz")


best_model = LinearRegression()
best_model.load("best_regression_model_2.npz")
