...
mini_batch_model.load("classification_mini_model_2.npz")
...
batch_model.load("classification_batch_model_2.npz")
...
stochastic_model.load("classification_stochastic_model_2.npz")
...
normal_equation_model.load("classification_normal_model_2.npz")
...
print(best)
best.save("best_classification_model_2.npz")


best_model = LogisticRegression()
best_model.load("best_classification_model_2.npz")
