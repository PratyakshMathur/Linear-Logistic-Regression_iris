...
import numpy as np
from train_LinearRegression4 import X_test,y_test

mini_batch_model = LinearRegression()
mini_batch_model.load("models/regression4_mini_model_1.npz")
...
batch_model.load("models/regression4_batch_model_1.npz")
...
stochastic_model.load("models/regression4_stochastic_model_1.npz")
...
normal_equation_model.load("models/regression4_normal_equation_model_1.npz")
...
best.save("models/best_regression_model_4.npz")


best_model = LinearRegression()
best_model.load("models/best_regression_model_4.npz")
