...
import numpy as np
from train_LinearRegression1 import X_test,y_test

mini_batch_model = LinearRegression()
mini_batch_model.load("models/regression1_mini_model_1.npz")
...
batch_model.load("models/regression1_batch_model_1.npz")
...
stochastic_model.load("models/regression1_stochastic_model_1.npz")
...
normal_equation_model.load("models/regression1_normal_equation_model_1.npz")
...
best.save("models/best_regression_model_1.npz")


best_model = LinearRegression()
best_model.load("models/best_regression_model_1.npz")
