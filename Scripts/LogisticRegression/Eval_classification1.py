...
import numpy as np
from train_classification_1 import X_test,y_test,target_names
from sklearn.metrics import classification_report
# Load all model

mini_batch_model = LogisticRegression()
mini_batch_model.load("models/classification_mini_model_1.npz")
...
batch_model.load("models/classification_batch_model_1.npz")
...
stochastic_model.load("models/classification_stochastic_model_1.npz")
...
normal_equation_model.load("models/classification_normal_model_1.npz")
...
print(best)
best.save("models/best_classification_model_1.npz")


best_model = LogisticRegression()
best_model.load("models/best_classification_model_1.npz")
