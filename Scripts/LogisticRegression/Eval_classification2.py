...
plot_decision_boundary(mini_batch_model,X_test,y_pred,"Plot-logistic-regression-mini-model-2")
...
batch_model.load("models/classification_batch_model_2.npz")
y_pred = batch_model.predict(X_test)
plot_decision_boundary(batch_model,X_test,y_pred,"Plot-logistic-regression-batch-model-2")
...
stochastic_model.load("models/classification_stochastic_model_2.npz")
y_pred = stochastic_model.predict(X_test)
plot_decision_boundary(stochastic_model,X_test,y_pred,"Plot-logistic-regression-stochastic-model-2")
...
normal_equation_model.load("models/classification_normal_model_2.npz")
y_pred = normal_equation_model.predict(X_test)
plot_decision_boundary(normal_equation_model,X_test,y_pred,"Plot-logistic-regression-normal-model-2")

n_loaded_acc = normal_equation_model.score(X_test, y_test)
print(f"Normal Loaded Model Accuracy: {n_loaded_acc:.4f}")
...
print(best)
best.save("models/best_classification_model_2.npz")
...
plot_decision_boundary(best_model,X_test,y_pred,"Plot-logistic-regression-best-model-2")
