...
import numpy as np
from LinearRegression3 import X_test,y_test

mini_batch_model = LinearRegression_single()
mini_batch_model.load("regression3_mini_model_1.npz")

batch_model = LinearRegression_single()
batch_model.load("regression3_batch_model_1.npz")

stochastic_model = LinearRegression_single()
stochastic_model.load("regression3_stochastic_model_1.npz")

normal_equation_model = LinearRegression_single()
normal_equation_model.load("regression3_normal_equation_model_1.npz")
