...
def main():
    ...
    sgd_model.save("classification_stochastic_model_2.npz")
    ...
    bgd_model.save("classification_batch_model_2.npz")
    ...
    mbgd_model.save("classification_mini_model_2.npz")
    ...
    ne_model.save("classification_normal_model_2.npz")
