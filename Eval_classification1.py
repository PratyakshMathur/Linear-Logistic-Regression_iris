...
mini_batch_model.load("classification_mini_model_1.npz")
...
batch_model.load("classification_batch_model_1.npz")
...
stochastic_model.load("classification_stochastic_model_1.npz")
...
normal_equation_model.load("classification_normal_model_1.npz")
...
print(best)
best.save("best_classification_model_1.npz")


best_model = LogisticRegression()
best_model.load("best_classification_model_1.npz")
